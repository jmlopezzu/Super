...
st.title("Integración Super 2023-1")
st.markdown("## Equipo de Transformacion digital")
st.markdown("<h1 style='text-align: center;'> Nuevos talentos </h>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center;'>Camila López, Isabella Saldaña, Leonardo Grisales y José Miguel López</h4>", unsafe_allow_html=True)
st.markdown("")
...
st.markdown("") 
st.markdown("<h3 style='text-align: center;'> Preguntas Super </h3>", unsafe_allow_html=True)
st.markdown("") 
